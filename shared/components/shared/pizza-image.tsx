...
export const PizzaImage: React.FC<Props> = ({ imageUrl, size, className }) => {
	return (
		<div
			className={cn(
				'bg-[#FFF7EE] flex items-center justify-center flex-1 relative w-full',
				className
			)}
		>
			<img
				...
				className={cn(
					...
					{
						'w-[300px] h-[300px] max-lg:w-[150px] max-lg:h-[150px]':
							size === 20,
						'w-[400px] h-[400px] max-lg:w-[350px] max-lg:h-[350px]':
							size === 30,
						'w-[500px] h-[500px] max-lg:w-[450px] max-lg:h-[450px]':
							size === 40,
					}
				)}
			/>
